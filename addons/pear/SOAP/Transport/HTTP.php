...
// Otherwise by autogenerated WSDL proxy classes it would not be possibele to add additional CURL parameters

		if (defined('DD_SERVER_CA_FILE') === true) {
			curl_setopt($ch, CURLOPT_SSL_VERIFYHOST,    1);
			curl_setopt($ch, CURLOPT_SSL_VERIFYPEER,    1);
			curl_setopt($ch, CURLOPT_CAINFO, DD_SERVER_CA_FILE);
		} else {
