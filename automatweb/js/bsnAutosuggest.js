...
var bsnAsFilename = "css/bsnautosuggest.css";
var bsnAsFileref = document.createElement("link");
bsnAsFileref.setAttribute("rel", "stylesheet");
bsnAsFileref.setAttribute("type", "text/css");
bsnAsFileref.setAttribute("href", bsnAsFilename);
if (typeof bsnAsFileref != "undefined")
{
	document.getElementsByTagName("head")[0].appendChild(bsnAsFileref);
}
...
{
	if (!this.oP.shownoresults && arr.length == 0)
	{
		this.clearSuggestions();
		return;
	}
