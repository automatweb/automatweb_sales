			...
			contents : [
				...
				},
				{
					...
					[
						{
							type:'html',
							html:'<div style="height:40px" class="cke_dialog_ui_text" id="id_uiElement" role="presentation"><label for="id_textInput" id="id_label" class="cke_dialog_ui_labeled_label">Id</label><div role="presentation" class="cke_dialog_ui_labeled_content"><div role="presentation" class="cke_dialog_ui_input_text"><input type="text" aria-labelledby="id_label" size="38" id="flash_id_textInput" class="cke_dialog_ui_input_text"></div></div></div><div style="height:40px" class="cke_dialog_ui_text" id="name_uiElement" role="presentation"><label for="flash_name_textInput" id="name_label" class="cke_dialog_ui_labeled_label">Name</label><div role="presentation" class="cke_dialog_ui_labeled_content"><div role="presentation" class="cke_dialog_ui_input_text"><input type="text" size="38" id="flash_name_textInput" class="cke_dialog_ui_input_text"></div></div></div>',
						},
						{
							type:'html',
							html:'<a id="cke_360_uiElement" aria-labelledby="cke_359_label" role="button" class="cke_dialog_ui_button" hidefocus="true" title="Search" href="javascript:search_flash()" style="-moz-user-select: none;"><span class="cke_dialog_ui_button" id="cke_359_label">Search</span></a><div id="flash_search_results" style="overflow:auto;height:240px;margin-top:10px;"></div>',
						}
					]
				},
				{
...
{
	var sid = document.getElementById('flash_id_textInput');
	var sname = document.getElementById('flash_name_textInput');
	if(sid.value != "" || sname.value != "")
	{
		...
		ajaxRequest.onreadystatechange = function(){
			if(ajaxRequest.readyState == 4){
				var ajaxDisplay = document.getElementById('flash_search_results');
				ajaxDisplay.innerHTML = ajaxRequest.responseText;
			//	alert(ajaxRequest.responseText);
			}
		}
		
		var queryString = "?class=flash&action=search_flash&sid=" + sid.value + "&sname=" + sname.value;
...
function set_flash(strLink)
{
	...
	var tUrl = dialog.getContentElement('info', 'src');
