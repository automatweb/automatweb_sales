...
{ 
  ...
  if (this.level>0) 
    if (this.isLastNode) //the last child in the children array 
	    leftSide = leftSide + "<td class='fgtext_bad' valign=top>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0></a></td>"
    else 
      leftSide = leftSide + "<td class='fgtext_bad' valign=top background=" + ICONPATH + "ftv2vertline.gif>" + auxEv + "<img name='nodeIcon" + this.id + "' id='nodeIcon" + this.id + "' src='" + nodeName + "' width=16 height=22 border=0></a></td>"
  ...
  docW = docW + "<tr>" + leftSide + "<td class='fgtext_bad' valign=top>";
  if (USEICONS)
  {
  ...
  if (WRAPTEXT)
	  docW = docW + "</td><td valign=middle class='fgtext_bad' width=100%>"
  else
	  docW = docW + "</td><td valign=middle class='fgtext_bad' nowrap width=100%>"
  if (USETEXTLINKS) 
  { 
...
{ 
  ...
  var fullLink = "href=\""+this.link+"\" onClick=\"clickOnLink('"+this.getID()+"\', '"+this.link+"','');return false;\"";
  this.isRendered = 1

  if (this.level>0) 
    if (this.isLastNode) //the last 'brother' in the children array 
    { 
      leftSide = leftSide + "<td valign=top class='fgtext_bad'><img src='" + ICONPATH + "ftv2lastnode.gif' width=16 height=22></td>"
    } 
    else 
    { 
      leftSide = leftSide + "<td valign=top class='fgtext_bad' background=" + ICONPATH + "ftv2vertline.gif><img src='" + ICONPATH + "ftv2node.gif' width=16 height=22></td>"
    } 

  docW = docW + this.blockStartHTML("item")

  docW = docW + "<tr>" + leftSide + "<td valign=top class='fgtext_bad'>"
  if (USEICONS)
  ...
  if (WRAPTEXT)
    docW = docW + "</td><td valign=middle width=100% class='fgtext_bad'>"
  else
    docW = docW + "</td><td valign=middle nowrap width=100% class='fgtext_bad'>"
