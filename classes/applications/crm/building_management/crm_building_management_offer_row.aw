...
@classinfo syslog_type=ST_CRM_BUILDING_MANAGEMENT_OFFER_ROW relationmgr=yes no_comment=1 no_status=1 prop_cb=1 maintainer=dragut
...
class crm_building_management_offer_row extends class_base
{
	...
	{
		$this->init(array(
			"tpldir" => "applications/crm/building_management/crm_building_management_offer_row",
			"clid" => CL_CRM_BUILDING_MANAGEMENT_OFFER_ROW
		));
	}
