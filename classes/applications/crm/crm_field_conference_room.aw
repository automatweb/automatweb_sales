...
@classinfo syslog_type=ST_CRM_FIELD_CONFERENCE_ROOM no_comment=1 no_status=1 prop_cb=1 maintainer=markop
...
@default group=rooms
	@property rooms type=releditor mode=manager reltype=RELTYPE_ROOM props=name,area,description,type_chair,type_chair_table,type_conference_table,type_u_table,type_oval_table,type_chair_diag
...
class crm_field_conference_room extends class_base
{
	...
	function crm_field_conference_room()
	{
		...
		$this->init(array(
			"tpldir" => "applications/crm/crm_field_conference_room",
			"clid" => CL_CRM_FIELD_CONFERENCE_ROOM
		));
	}
