...
@classinfo syslog_type=ST_REALESTATE_COTTAGE relationmgr=yes no_comment=1 no_status=1 trans=1 maintainer=voldemar
...
class realestate_cottage extends realestate_property
{
	const AW_CLID = 978;

	function realestate_cottage()
	{
		$this->init(array(
			"tpldir" => "applications/realestate_management/realestate_cottage",
			"clid" => CL_REALESTATE_COTTAGE
		));
	}
