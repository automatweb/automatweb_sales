...
@default group=grp_detailed
	...
	@groupinfo house_info parent=grp_detailed caption="Maja üldinfo"
	@default group=house_info
	...
	@groupinfo property parent=grp_detailed caption="Krunt"
	@caption Krunt
	...
	@groupinfo house parent=grp_detailed caption="Maja"
	@default group=house
		...
		@caption Konstruktsioon

			@property bearing_walls type=textbox table=realestate_property
			@caption Kandeseinad

			@property interior_walls type=textbox table=realestate_property
			@caption Siseseinad

			@property interior_ceilings type=textbox table=realestate_property
			@caption Vahelaed
		...
		@caption Viimistlus
			...
			@property frontage type=textbox field=meta method=serialize
			@caption Fassaad
		...
		@property childtitle101 type=text store=no subtitle=1
		@caption Toad
		...
		@property childtitle1011 type=text store=no subtitle=1
		@caption="Sanitaarruumid"
		...
		@property childtitle133 type=text store=no subtitle=1
		@caption="Muu viimistlus"
...
class realestate_house extends realestate_property
{
	...
	{
		$this->init(array(
			"tpldir" => "applications/realestate_management/realestate_house",
