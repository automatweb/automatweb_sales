...
@classinfo syslog_type=ST_SHOP_PERIOD_SETTINGS relationmgr=yes maintainer=kristo
...
class shop_period_settings extends class_base
{
	...
	function shop_period_settings()
	{
		...
		$this->init(array(
			"tpldir" => "applications/shop/shop_period_settings",
			"clid" => CL_SHOP_PERIOD_SETTINGS
		));
	}
