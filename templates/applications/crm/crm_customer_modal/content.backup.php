			...
			<div class="tab-pane" id="contact-address">
				...
				<table class="table table-hover table-condensed form-inline">
					...
					<tfoot>
						<tr>
							<td>
								<select id="contact-address-country" data-bind="value: customer().address_selected().country" class="input-small">
							...
							<td><input type="text" data-bind="value: customer().address_selected().county_caption" data-provide="typeahead" data-address-field="county" class="input-mini" /></td>
							<td><input type="text" data-bind="value: customer().address_selected().city_caption" data-provide="typeahead" data-address-field="city" class="input-mini" /></td>
							<td><input type="text" data-bind="value: customer().address_selected().vald_caption" data-provide="typeahead" data-address-field="vald" class="input-mini" /></td>
							<td><input type="text" data-bind="value: customer().address_selected().street" class="input-mini" /></td>
							<td>
								<input type="text" data-bind="value: customer().address_selected().house" class="input-micro" />
								- <input type="text" data-bind="value: customer().address_selected().apartment" class="input-micro" />
							</td>
							<td><input type="text" data-bind="value: customer().address_selected().postal_code" class="input-mini" /></td>
							<td>
							...
							<td>
								<input type="text" data-bind="value: customer().address_selected().details" class="input-mini" />
							</td>
							<td>
								<a href="javascript:void(0)" data-bind="click: customer().saveAddress"><i class="icon-ok"></i></a> &nbsp;
								<a href="javascript:void(0)" data-bind="click: customer().resetAddress"><i class="icon-remove"></i></a>
							</td>
						</tr>
					</tfoot>
				</table>
