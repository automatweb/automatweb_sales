...
<tr class="sisu">
	...
	<tr>
		...
		<!-- SUB: re_number_of_rooms -->
		{VAR:caption}: <strong>{VAR:value}</strong><br> 
		<!-- END SUB: re_number_of_rooms -->

		<!-- SUB: re_number_of_bathrooms -->
		{VAR:caption}: <strong>{VAR:value}</strong><br> 
		<!-- END SUB: re_number_of_bathrooms -->
		...
		<!-- SUB: re_number_of_bedrooms -->
		{VAR:caption}: <strong>{VAR:value}</strong><br> 
		<!-- END SUB: re_number_of_bedrooms -->
		...
		{VAR:caption}: <strong>{VAR:value}</strong> kr
	...
	<!-- SUB: re_additional_info_et -->
	<strong>Info:</strong> {VAR:value}<br>
	<br>
	<!-- END SUB: re_additional_info_et -->
...
<tr class="sisu">
	...
	<tr>
		...
		<td class="foto"><img src="{VAR:value}" alt="">
