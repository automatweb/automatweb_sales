...
<input type="submit" class='doc_button' value="Salvesta"> <input class='doc_button' type="submit" value="Eelvaade" onClick="window.location.href='{VAR:preview}';return false;"> <input type="submit" class='doc_button' value="Sektsioonid" onClick="window.location.href='{VAR:menurl}';return false;"> <input type="submit" class='doc_button' value="Webile" onClick="window.open('{VAR:baseurl}/index{VAR:ext}?section={VAR:id}');return false;"> <input type="submit" class='doc_button' value="Teised keeled" onClick="window.location.href='{VAR:lburl}';return false"> <input type="button" class="doc_button" value="Teavita liste" onClick="if (confirm('Teavitada liste?')) { window.location.href='{VAR:self}?class=keywords&action=notify&id={VAR:docid}';}"> 
</td>
</tr>
<!-- SUB: DOC_BROS -->
<tr>
			...
			<table border=0 cellspacing=1 cellpadding=2 bgcolor="#CCCCCC" width="100%">
				<tr>
					<td class="hele_hall_taust">
						Aktiivne:	<select name="status" class='tekstikast'>{VAR:status}</select>
...
<iframe name="title_edit" onFocus="sel_el='title_edit'" frameborder="1" width="100%" height="50"></iframe>
</td>
</tr>
<tr>
<td class="hele_hall_taust" valign="top"><b>&nbsp;Lead&nbsp;</b></td>
<td class="hele_hall_taust">
<iframe name="lead_edit" onFocus="sel_el='lead_edit'" frameborder="1" width="100%" height="100"></iframe>
<input type='hidden' name="lead" value="{VAR:lead}">
</td>
</tr>
<tr>
<td class="hele_hall_taust" valign="top"><b>&nbsp;Sisu&nbsp;</b></td>
<td class="hele_hall_taust"><iframe onFocus="sel_el='cont_edit'" name="cont_edit" frameborder="1" width="100%" height="400"></iframe>
...
<script for=window event=onload>
	...
	cont_edit.document.write("<body style='font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 12px;background-color: #FFFFFF; border: #CCCCCC solid; border-width: 1px 1px 1px 1px; margin-left: 0px;padding-left: 3px;	padding-top: 3px;	padding-right: 3px; padding-bottom: 3px;'>");
	cont_edit.document.write(doc.content.value);

	lead_edit.document.designMode='On';
	lead_edit.document.write("<body style='font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 12px;background-color: #FFFFFF; border: #CCCCCC solid; border-width: 1px 1px 1px 1px; margin-left: 0px;padding-left: 3px;	padding-top: 3px;	padding-right: 3px; padding-bottom: 3px;'>");
	lead_edit.document.write(doc.lead.value);

	title_edit.document.designMode='On';
	title_edit.document.write("<body style='font-family: Verdana, Arial, Helvetica, sans-serif;font-size: 12px;background-color: #FFFFFF; border: #CCCCCC solid; border-width: 1px 1px 1px 1px; margin-left: 0px;padding-left: 3px;	padding-top: 3px;	padding-right: 3px; padding-bottom: 3px;'>");
