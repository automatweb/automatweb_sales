...
<td class="celltext"><input class='tekstikast' type="text" name="tm" size="20" value="{VAR:tm}"></td>
</tr>
...
<select onchange="format('forecolor',this[this.selectedIndex].style.color);this.selectedIndex=0" STYLE="font:8pt verdana,arial,sans-serif;background:#FFFFFF">
										...
										<option style="color:#213E78">UT sinine</option>
										<option style="color:#B5B7B7">UT hall</option>
...
<td align="center" class="icontext"><IMG SRC="{VAR:baseurl}/images/trans.gif" WIDTH="2" HEIGHT="2" BORDER=0 ALT=""><br><a href="{VAR:baseurl}/index.aw?section={VAR:id}"
...
href="{VAR:baseurl}/index.aw?section={VAR:id}">Eelvaade</a></td>
<td><IMG SRC="{VAR:baseurl}/images/trans.gif" WIDTH="10" HEIGHT="2" BORDER=0 ALT=""></td>
