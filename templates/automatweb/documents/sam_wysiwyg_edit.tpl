				...
				<tr>
					<td class="hele_hall_taust">
						Aktiivne:	<select name="status" class='tekstikast'>{VAR:status}</select>
 						...
 						Pealkiri n&auml;htav:	<input type='checkbox' name="show_title" {VAR:show_title} value=1>
 						Lead uudiste paanis:	<input type='checkbox' name="show_modified" {VAR:show_modified} value=1>
					</td>
				</tr>
			</table>
		</td>
