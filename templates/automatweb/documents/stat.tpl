...
<table border=0 cellpadding=0 cellspacing=0>
	...
	| N‰ita kuup&auml;eva: <input type='checkbox' name='show_modified' value=1 {VAR:show_modified}>
...
<tr>
<td class="hele_hall_taust"><img src='{VAR:baseurl}/images/transa.gif' width=110 height=1><Br><B>&nbsp;Muutmise kuup&auml;ev:&nbsp;</b></td>
