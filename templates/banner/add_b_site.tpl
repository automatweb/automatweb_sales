...
<tr>
	<td class="fcaption2">{VAR:LC_BANNER_POSITIONS}</td>
	<td class="fform"><select name='locations[]' multiple>{VAR:locations}</select></td>
</tr>
<tr>
...
<!-- SUB: CHANGE -->
<tr>
	<td class="fcaption2" colspan=2 valign="top"><a href='{VAR:stats}'>{VAR:LC_BANNER_SITE_STATISTICS}</a></td>
</tr>
<!-- END SUB: CHANGE -->
<tr>
