...
<tr>
	<td class="fcaption2" valign="top">{VAR:LC_BANNER_HOUR}</td>
	<td class="fform">{VAR:LC_BANNER_LOOKS}</td>
	<td class="fform">{VAR:LC_BANNER_CLICKS}</td>
</tr>
<!-- SUB: LINE -->
<tr>
	<td class="fcaption2" valign="top">{VAR:hr}</td>
...
<tr>
	<td colspan=2 class="fcaption2">{VAR:LC_BANNER_AVERAGE_LOOKS_IN_HOUR}:</td>
...
<tr>
	<td colspan=2 class="fcaption2">{VAR:LC_BANNER_AVERAGE_CLICKS_IN_HOUR}:</td>
