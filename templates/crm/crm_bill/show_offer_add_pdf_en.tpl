...
<table class="header">
<tr>
	<td width="40%" class="logo"><img src="http://intranet.automatweb.com/img/automatweb.jpg" alt="AutomatWeb" width="277" height="48">
	<td width="35%">
...
<tr>
	...
	<td width="10%" class="heading"><strong>Date</strong></td>
