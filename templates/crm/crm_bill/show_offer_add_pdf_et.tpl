<html>
<head>
	<title>Pakkumuse nr {VAR:bill_no} nõuded</title>
	<style>
...
if(isset($pdf))
{
	...
	$x = $w - $width;
	$pdf->page_text($x/10, $y, "Pakkumuse nr {VAR:bill_no} nõuded", $font, $size, $color);
...
<tr>
	<td colspan="3">
		<h1>Pakkumuse nr {VAR:bill_no} nõuded</h1>
	</td>
</tr>
<!-- SUB: HAS_COMMENT -->
<tr>
...
<tr>
	...
	<td width="10%" class="heading"><strong>Tähtpäev</strong></td>
	<td width="40%" class="heading"><strong>Kirjeldus</strong></td>
	<td width="5%" class="heading"><strong>Ühik</strong></td>
	<td width="5%" class="heading"><strong>Kogus</strong></td>
	<td width="10%" class="heading"><strong>Hind ({VAR:ord_currency_name})</strong></td>
