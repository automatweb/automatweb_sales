...
<table id="bill" cellpadding="0" cellspacing="0" border="0">
	...
	<tr>
		...
		<td class="remind">
			<img src="http://intranet.automatweb.com/img/bill/kordusarve.gif" width="227" height="60">
		</td>
	</tr>
	<tr>
		<td class="info">
		...
		<td class="info">
			<table cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<td class="caption">Arve kuupäev:</td>
					<td class="content">{DATE:bill_date|d.m.Y}</td>
				</tr>
				<tr>
					<td class="caption">Maksetähtaeg:</td>
					<td class="content">{VAR:bill_due}</td>
				</tr>
				<tr>
					<td class="caption">Viivis:</td>
					<td class="content bottom">{VAR:overdue}% päevas</td>
				</tr>
			</table>
		</td>
	</tr>
	<tr>
		<td colspan="2" class="main">
			<table cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					<td colspan="4" class="caption">Summa koos käibemaksuga:</td>
