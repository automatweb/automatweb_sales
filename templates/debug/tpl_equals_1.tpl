...
.jqDrag {
	width: 100%;
	cursor: move;
	background: url(/automatweb/images/aw06/layout_t.gif) repeat-x;
	height: 25px;
}
...
<div id="tpl_equals_1" style="position: absolute; left: 20px; margin: 0 auto; border: 1px solid #0373AC; background: white; color: black; margin-top: 35px; background: white; width: auto; z-index: 9999; font-size: 10px; font-family: Verdana;">
